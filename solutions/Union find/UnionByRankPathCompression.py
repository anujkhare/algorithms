...
## Topic:: Union Find
## Sub-topic:: Union by rank, Path compression
## Difficulty:: Medium
## Approach:: Similar to vanilla union-find. The major difference is that you track the "rank" (approx height) of each node and put the smaller one under the larger one. If both nodes have the same rank, make anyone the root and increment it's rank by 1.
## Time complexity:: O(logN)
## Space complexity:: O(logN)
## Notes:: Create a class for the node. The path compression works by simply setting the root as the parent for each node. Easily done recursively!
